...
// and возвращает валидатор, который проверяет, что все переданные ему валидаторы вернули true
...
// or возвращает валидатор, который проверяет, что хотя бы один переданный ему валидатор вернул true
